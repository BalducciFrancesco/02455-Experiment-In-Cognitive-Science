...
function r_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    r_instructionsComponents.forEach( function(thisComponent) {
...
function r_baselineRoutineBegin(snapshot) {
  return async function () {
    ...
    r_baselineComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function r_preparationRoutineBegin(snapshot) {
  return async function () {
    ...
    r_preparationComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function r_fixationRoutineBegin(snapshot) {
  return async function () {
    ...
    r_fixationComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function r_videoRoutineBegin(snapshot) {
  return async function () {
    ...
    r_videoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function r_SAM_1RoutineBegin(snapshot) {
  return async function () {
    ...
    r_SAM_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function r_SAM_2RoutineBegin(snapshot) {
  return async function () {
    ...
    r_SAM_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function r_SAM_3RoutineBegin(snapshot) {
  return async function () {
    ...
    r_SAM_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function r_focus_questionnaireRoutineBegin(snapshot) {
  return async function () {
    ...
    r_focus_questionnaireComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function r_final_questionnaireRoutineBegin(snapshot) {
  return async function () {
    ...
    r_final_questionnaireComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
